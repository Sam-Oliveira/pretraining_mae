...
# Script that gets called when doing fine-tuning. Relies on engine_finetune.py and models_mae_finetune.py
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./output_dir_ftNA25k',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./output_dir_ftNA25k',
...
def main(args):
    ...
    if args.finetune and not args.eval:
        ...
        # Uncomment lines below to Freeze encoder
    ...
    if args.eval:
        test_stats = evaluate(data_loader_val, model, device, 0, args = args)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        test_stats = evaluate(data_loader_val, model, device, epoch, args = args)
